...
class DragonERPWebApiRunner(CSCWebAPI):
    ...
    def load_skill_from_db(self):
        ...
        with self.session_maker() as _session:
            config_json = load_skill_config_from_db("DragonERPWebApiRunner",
    ...
    def run_actions(self,user:User,schema_input: dict[str,Any] | list[dict[str,Any]], cookies=None)-> list[Any]:
        ...
        actions_responses = run_actions(dragon_session, input_data, self.config)
        resp_text = []
