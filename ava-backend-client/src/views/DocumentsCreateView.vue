...
import { usefileStore, useStateStore } from "../store/index";
import { storeToRefs } from "pinia";

import axios1 from "axios";
const stateStore = useStateStore();
const { datasetsName, datasetsFolderName } = storeToRefs(stateStore);
...
<template>
    <div class="documents_create">
        <div class="process">
            <div class="title">
                <router-link :to="`/datasets/${datasets_id}/documents`"
        ...
        <div class="main" v-else>
            ...
            <div class="datas_name_item">
                <p class="datas_label">上傳至知識庫名稱</p>
            ...
            <router-link :to="`/datasets/${datasets_id}/documents`" class="btn_document">
                前往文件
