const j1 = {
    system_prompt:
        "You are a courteous HR officer who is well-versed in the company's leave management \n" +
...
VALUES('4373cbe5-41b0-4dba-bb75-a413fc887140', 'ERP專家', '歡迎使用ERP專家', './robot.png', 'vR1AnoG0clzKbu2H');`,
    ...
    `ALTER TABLE public.bot_messages ADD CONSTRAINT bot_messages_un UNIQUE (users_uid,expert_id);`,
    ...
    `ALTER TABLE public.datasets ADD "describe" varchar(1000) NULL;
    ...
    `ALTER TABLE public.documents ADD training_state int4 NOT NULL DEFAULT 0;`,
    ...
    `ALTER TABLE public.recommend_custom ADD CONSTRAINT recommend_custom_fk FOREIGN KEY (users_uid) REFERENCES public.users(uid) ON DELETE CASCADE;`,

    `CREATE TABLE public.recommend_history (
	users_uid varchar(50) NOT NULL, -- 使用者id
    ...
    `ALTER TABLE public.recommend_history ADD CONSTRAINT recommend_history_fk FOREIGN KEY (users_uid) REFERENCES public.users(uid) ON DELETE CASCADE;`,
    `INSERT INTO public.datasets
(id, "name", "describe", config_jsonb, folder_name)
VALUES('070f03a5-9d31-4b49-8b63-43eccfc7d9ba', 'hd', 'useful for when you want to answer queries about the hd', $$${JSON.stringify(
        j1
    )}$$, 'hd'),
('0fd060f9-dc44-4c16-9480-9220f1fa73a3', 'biztrip', 'useful for when you want to answer queries about the biztrip', $$${JSON.stringify(
        j2
    )}$$, 'biztrip'),
('30f3d749-2f3b-45f1-8a23-bd6746b90dfd', 'contracts', 'useful for when you want to answer queries about the contracts', $$${JSON.stringify(
        j3
    )}$$, 'contracts'),
('ab15f10d-d37d-45ca-96f2-0273c63f7467', 'op', 'useful for when you want to answer queries about the op', $$${JSON.stringify(
        j4
    )}$$, 'op')`,
    `INSERT INTO public.expert_datasets_mapping
