...
const titles = ref([
    ...
    { title: "儲存的對話歷史", icon: "fa-regular fa-comment-dots" },
]);
...
.recommend {
    ...
    .list {
        ...
        .item {
            ...
            transition: 0.3s;
            border: 1px solid rgba($color: #57b0b7, $alpha: 0.3);
            word-break: break-all;

            &:hover {
                border: 1px solid #57b0b7;
            }
        }
        .hover {
            .item {
    ...
    .custom {
        ...
        .addItem {
            display: flex;
            justify-content: space-between;
            background-color: rgba($color: #57b0b7, $alpha: 0.3);
        }
        .addInput {
            width: 100%;
            display: flex;
            ...
            textarea {
                ...
                overflow: hidden;
                &:focus {
                    border: 1px solid rgba($color: #57b0b7, $alpha: 1);
                }
            }
            p {
                cursor: pointer;
