...
const js_program = async function () {
    ...
    try {
        const sqlArr = [
            ...
            VALUES('is_db_ready', '1', '2024-04-02 11:05:51.106', '2024-07-08 16:17:30.612');`,
            `INSERT INTO public.settings
            ("key", value, create_time, update_time)
            VALUES('precise_cache_mode', '0', '2024-07-22 16:25:57.506', '2024-07-22 16:30:45.634');`,
            ...
            VALUES('5a437597-b9dc-44ac-ab3a-c244bc416847', '高雄市市民小幫手', '歡迎使用', './robot.png', 'DDGbnBc9T2qdHgZv', '{"model_params":{"top_p":1,"max_tokens":1200,"temperature":0,"frequency_penalty":0},"system_prompt":"","suggest_question":"","content_replacement_list":"{}"}'::jsonb, 1, 0, 0, NULL, '2024-03-23 10:40:45.710', '2024-03-23 10:40:45.710');
            `,
