...
import CardRangeComponent from "@/components/kaohsiung/cards/CardRangeComponent.vue";
import CardSingleComponent from "@/components/kaohsiung/cards/CardSingleComponent.vue";
import CardMultiComponent from "@/components/kaohsiung/cards/CardMultiComponent.vue";
    ...
    <div class="cards_box">
        ...
        <div class="cards" ref="cards">
            <div class="flex flex-col card" v-for="(card, index) in data.data" :key="index">
                ...
                <div v-if="card.type === 'start_end'" class="flex-1">
                    <CardRangeComponent
                        :card="card"
                ...
                <div v-else-if="card.type === 'multi'" class="flex-1">
                    <CardMultiComponent :card="card" @pushForm="pushForm" @pushText="pushText"></CardMultiComponent>
                </div>
                <div v-else-if="card.type === 'single'" class="flex-1">
